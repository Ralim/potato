...
This comes from mcu.kicad_sch, but is broken out for discussion and to be of more immediate use to those not versed in Kicad.

As of March 14, Robert is uncomfortable with Pin 16. Section 3.2.5 on page 25 describes the veraitle 
pin muxing available on the BL60x parts. Ishows that we can populate the five bit mode enum to bring 
